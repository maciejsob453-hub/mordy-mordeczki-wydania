...
function loadCode(code){
  ...
  G.goals=G.goals||{};G.nationalGoals=G.nationalGoals||{};G.partyCouncil=G.partyCouncil||null;G.agents=G.agents||{};G.aiAgentAt=G.aiAgentAt||{};G.tutSeen=G.tutSeen||{};G.sits=G.sits||[];G.polls=G.polls||[];
...
/* ---- eksport uchwytów ---- */
  Object.assign(window,{radykalowie,radykalowieWszystkim,iskra,waznePozycje,waznePasek,modyfikatory,podejrzyjScen,menuIdz,backToMenu,opisTrybu,mediaNumer,mediaKup,mediaNazwij,mediaSzef,mediaOdcinek,mediaFilm,slepyLos,kreWyjdz,kreatorDoPliku,kreatorDane,kreatorEkran,wczytajScenPlik,zapiszScenPlik,podglad,przewidz,start,pickParty,danina,openSave,doLobby,tryLoadFromSetup,marContinue,marDeclare,setMarWho,setHemi:m=>{G.hemiMode=m;render()},endWeek,runElection,doAct,sendTeam,tryGov,goOpo,summary,tg,pay,buyTrait:window.buyTrait||(()=>{}),buyStat:window.buyStat||(()=>{}),openPush:window.openPush||(()=>{}),prezPush:window.prezPush||(()=>{}),prezWait:window.prezWait||(()=>{}),togList,makeList,joinList,leaveList,resetLists,aiCoal,listWill,renameBloc:window.renameBloc||(()=>{}),shortFree:window.shortFree||(()=>{}),opoCard:window.opoCard||(()=>{}),opoParties:window.opoParties||(()=>{}),makeOpo:window.makeOpo||(()=>{}),joinOpo:window.joinOpo||(()=>{}),leaveOpo:window.leaveOpo||(()=>{}),modalName,actBack,openWerb,openWerb2,werbDo,werbChance,werbPool,openCreator,crClose,crSet,crSetR,crAdj,crImg,crRel,crPoach,crTake,crPeople,crFinish,creator,registerCustom,crCostOf,crMem,doGoal,goalTab,myGoals,myPartyGoals,myNationalGoals,chooseNationalBranch,chooseNationalEarlyBranch,chooseNationalOptional,startNationalGoal,openPartyCouncil,nationalGoalReady,nationalGoalDone,nationalGoalProgress,nationalGoalTick,NATIONAL_GOALS,goalReady,goalOk,switchIdentity,libBecome,hasLib,hasLib2,hasPost,hasLsd,hasKan,hasRob,hasPer,applyGoals,goalDone,GOALS,aiGoals,adsBecome,hasAds,hasHor,apBase,
...
window.__game={przewidz,podglad,get PROBA(){return PROBA},
  ...
  myGoals,myPartyGoals,myNationalGoals,chooseNationalBranch,chooseNationalOptional,startNationalGoal,openPartyCouncil,partyCouncilCandidates,goalsFocus,goalsZoom,goalsMapReset,initGoalsMap,nationalGoalReady,nationalGoalDone,nationalGoalProgress,nationalGoalTick,NATIONAL_GOALS,goalDone,goalOk,signAgent,agentFree,agentCost,agenciZostalo,AGENCI_NA_KADENCJE,
  ...
  aiTransfery,aiOpozycja,aiObsadzRade,aiProponujMinistra,aiMinisterOfferShow,aiRekonstrukcja,aiSad,znuzenie,hegemon,resortyPartii,leadWybrany,aiPlan,ustawPlany,aiPamiec,aiPamietaj,aiAgenda,govKontraktTick,
